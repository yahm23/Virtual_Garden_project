...
app.get('/plants/:temp/:humidity', (req, res) => {
  ...
  const url = `https://trefle.io/api/plants/?token=Sk1pZTUyTDVMWCtRaVcyaVpBbFl1QT09&comlete_data=true&is_main_species=true&temperature_minimum_deg_f>${temp}&precipitation_minimum>${humidity}`
...
app.get('/plantToSearch/:search', (req, res) => {
  ...
  const url = `https://trefle.io/api/plants/?token=Sk1pZTUyTDVMWCtRaVcyaVpBbFl1QT09&is_main_species=true&q=${search}&temperature_minimum_deg_f`
